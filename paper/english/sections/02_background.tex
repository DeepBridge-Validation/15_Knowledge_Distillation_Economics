...
Hinton et al. (2015) introduced knowledge distillation:
...
where $\hat{\beta}_i^{(b)}$ is the estimate of $\beta_i$ in bootstrap sample $b$.
...
\begin{itemize}
    \item \textbf{Chow Test}: Tests equality of coefficients between periods
