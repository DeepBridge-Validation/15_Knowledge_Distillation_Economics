...
\begin{itemize}
    ...
    \item \textbf{vs. XAI (SHAP/LIME)}: Intrinsic interpretability (not post-hoc)
\end{itemize}
...
Mullainathan \& Spiess (2017) argue that ML focuses on prediction, econometrics on inference.
