...
\begin{itemize}
    \item \textbf{Interpretable ML}: Goes beyond post-hoc explanations (SHAP/LIME), producing intrinsically interpretable models
...
\begin{itemize}
    ...
    \item Compatibility with causal inference (IV, diff-in-diff, RDD)
